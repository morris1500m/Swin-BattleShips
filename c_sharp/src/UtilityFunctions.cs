...
namespace Battleship
{
    ...
    class UtilityFunctions
    {
        ...
        private Color SMALL_SHIP = SwinGame.Color.Gray;
        ...
        private Color LARGE_SHIP = SwinGame.Color.Gray;
        ...
        private Color SHIP_FILL_COLOR = SwinGame.Color.Gray;

        private Color SHIP_OUTLINE_COLOR = SwinGame.Color.White;
        ...
        private List<Sprite> _Animations = new List<SwinGame.Sprite>();
